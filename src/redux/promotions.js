...
import {PROMOTIONS} from '../shared/promotions';  //imported to campsites.js reducer
...
export const Promotions = (state=PROMOTIONS, action) => {
    ...
    switch (action.type) {
        //siwtch not required but common. right now we don't have action type defined so we use a default case to return the state: 
        default:
...
//then we goto configureStore.js